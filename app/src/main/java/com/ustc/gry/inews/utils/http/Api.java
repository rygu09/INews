...
public class Api {
     ...
     * 百度API接口
     */
    public static final String BAIDU_API_HOST = "http://apis.baidu.com";
    /**
     * 百度开发者API密钥
     */
     ...
     * 图片
     */
    public static final String Picture="/showapi_open_bus/pic/pic_search";
    // 校花
    public static final String Picture_XIAOHUA_ID = "4001";
    // 萌女
    public static final String Picture_MENGNV_ID = "4002";
    // 清纯
    public static final String Picture_QINGCHUN_ID = "4003";
    ...
    public static String getHost(int hostType) {
        switch (hostType) {
            case HostType.NETEASE_NEWS://新闻
                return Api.NETEAST_HOST;
            case HostType.NETEASE_VIDEO://视频
                return Api.NETEAST_HOST;
            case HostType.BAIDU_API_PHOTO://图片
                return Api.BAIDU_API_HOST;
